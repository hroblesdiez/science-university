...
?>
    ...
    <div class="container container--narrow page-section">
        ...
        <div class="create-note">
            ...
            <textarea class="new-note-body" name="" id="" cols="30" rows="10" placeholder="Place your note here..."></textarea>
            <span class="submit-note">Create note</span>
            <span class="note-limit-message">Note limit reached: delete an existing one to create a new one.</span>
        </div>
