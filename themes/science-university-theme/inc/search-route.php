<?php
add_action('rest_api_init', 'us_register_search');

function us_register_search()
{
    register_rest_route('su/v1', 'search', array(
        'methods'   => WP_REST_SERVER::READABLE,
        'callback'  => 'usSearchResults'
    ));
}

function usSearchResults($data)
{
